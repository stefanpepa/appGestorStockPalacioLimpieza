    ...
    invoke(soapEnvelope, options, extraHeaders) {
        ...
        const p = new Promise((resolve, reject) => {
            return request.post({
                ...
                if (!httpResponse) {
                    return reject(new error_server_class_1.BaseError(500, "http-action-error", "No hay respuesta http", httpResponse));
                }
                if (!(httpResponse === null || httpResponse === void 0 ? void 0 : httpResponse.statusCode)) {
                    return reject(new error_server_class_1.BaseError(500, "http-action-error", "No existe statusCode en el response", httpResponse));
                }
